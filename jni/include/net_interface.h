 ...
 *返回值: 0 错误 1 成功 等待回调
 *****************************************************************************/
JVCLIENT_API int JVC_QueryDevice(char* pGroup, int nYST, int nTimeOut,
...
JVCLIENT_API void JVC_RegisterCallBack(FUNC_CCONNECT_CALLBACK ConnectCallBack,
		...
		FUNC_CCHATDATA_CALLBACK ChatData, FUNC_CTEXTDATA_CALLBACK TextData,
		FUNC_CDOWNLOAD_CALLBACK DownLoad, FUNC_CPLAYDATA_CALLBACK PlayData);
#else
...
JVCLIENT_API void JVC_Connect(int nLocalChannel, int nChannel,
		char *pchServerIP, int nServerPort, char *pchPassName,
		char *pchPassWord, int nYSTNO, char chGroup[4], int bLocalTry,
		int nTURNType, int bCache, int nConnectType, bool bPlayDirectly, int nVip, int tcp);
#else
JVCLIENT_API void JVC_Connect(int nLocalChannel,int nChannel,
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API void JVC_SendData(int nLocalChannel, unsigned char uchType,
...
JVCLIENT_API void JVC_TCPConnect(int nLocalChannel, int nChannel,
		char *pchServerIP, int nServerPort, char *pchPassName,
		char *pchPassWord, int nYSTNO, char chGroup[4], int bLocalTry,
		int nConnectType, int nTURNType);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_StartLANSerchServer(int nLPort, int nServerPort,
		FUNC_CLANSDATA_CALLBACK LANSData);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_LANSerchDevice(char chGroup[4], int nYSTNO, int nCardType,
		int nVariety, char chDeviceName[100], int nTimeOut,
		unsigned int unFrequence);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_WANGetChannelCount(char chGroup[4], int nYSTNO,
		int nTimeOutS);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_StartBroadcastServer(int nLPort, int nServerPort,
		FUNC_CBCDATA_CALLBACK BCData);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_BroadcastOnce(int nBCID, unsigned char *pBuffer, int nSize,
		int nTimeOut);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_GetHelpYSTNO(unsigned char *pBuffer, int *snSize);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_EnableLANTool(int nEnable, int nLPort, int nServerPort,
		FUNC_CLANTDATA_CALLBACK LANTData);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_LANToolDevice(char chPName[256], char chPWord[256],
		int nTimeOut);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_SendCMD(int nLocalChannel, unsigned char uchType,
		unsigned char *pBuffer, int nSize);
#else
 ...
 *****************************************************************************/
#ifndef WIN32
JVCLIENT_API int JVC_MOLANSerchDevice(char chGroup[4], int nYSTNO,
		int nCardType, int nVariety, char chDeviceName[100], int nTimeOut,
		unsigned int unFrequence);
#else
