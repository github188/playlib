...
import neo.droid.cloudsee.commons.MyUtils;
...
public class Jni {
	...
	public static native boolean startAudioRecord(int bit, int block);

	public static native boolean stopAudioRecord();

	public static native boolean setRecordVolume(float volume);
	 ...
	 * @return
	 */
	public static native boolean connectRTMP(int window, String url,
			Object surface, boolean isTryOmx, String thumbName);

	public static native boolean setAudioVolume(int window, float gain);
	...
	public static native boolean clearCache(int window);
